...
import { AlertCircle, CheckCircle, Church, FileText, LogOut, Search, User } from "lucide-react"
...
export default function ReligiousDashboard() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-bold text-gray-900">Religious Organization Dashboard</h1>
          </div>
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              <User className="h-5 w-5 text-gray-500" />
              <span className="text-sm font-medium">Imam Besim Rexhepi</span>
            </div>
            <Link href="/login">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Religious Burial Verification</h2>
            <p className="text-gray-600">Islamic Community of Kosovo</p>
          </div>
        ...
        <Tabs defaultValue="pending" className="w-full">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg flex items-center">
                  ...
                  Deaths Awaiting Religious Confirmation
                </CardTitle>
                <CardDescription>
                  These deaths have been reported and need your verification for burial services
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
          ...
          <TabsContent value="confirmed">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Deaths that have been verified by your religious organization</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
          ...
          <TabsContent value="reports">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Religious Organization Reports</CardTitle>
                <CardDescription>Generate and view statistical reports for your organization</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm">Burial Services Statistics</CardTitle>
                    </CardHeader>
